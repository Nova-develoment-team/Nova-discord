module.exports = {
  ...
  category: "Mod",
  explanation:
    "Disable sending messages for the specified role/user or the guild. Only executable by someone with the manage channels permissions.",
  user: "Manage Channels",
  bot: "Manage Channels",
  usage: "lock [role/user]",
  example: "lock bot-users",
  explain:
    "Locks the channel for the role **bot-users**. If it is a user, then it is locked for a user, else for the guild.",
...
$endif
$onlybotperms[managechannels;{description:I do not have the required permissions! Required permissions#COLON# \`Manage Channels\`}{color:$GetServervar[color]}]
$onlyperms[managechannels;{description:You do not have the permission \`Manage Channels\` to execute this!}{color:$GetServervar[color]}]

$log[[DEBUG] :: $username, used the lock command]
`,
};
