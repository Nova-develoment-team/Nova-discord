...
$suppressErrors[something just happened.
  ...
  $log[[DEBUG] :: $username, used the volume command]`,
  },
  {
    type: "awaitedCommand",
    name: "voldown",
...
$onlyIf[$voiceID!=;]
  ...
  $log[[DEBUG] :: $username, used the voldown command]`,
  },
  {
    type: "awaitedCommand",
    name: "volup",
...
$onlyIf[$voiceID!=;]
  ...
  $log[[DEBUG] :: $username, used the volup command]`,
  },
  {
    type: "awaitedCommand",
    name: "volmute",
...
$onlyIf[$voiceID!=;]
  ...
  $log[[DEBUG] :: $username, used the volmute command]`,
  },
];
