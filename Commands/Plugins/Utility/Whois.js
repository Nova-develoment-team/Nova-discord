...
$suppressErrors[{author:$userTag[$authorID]:$authorAvatar}{description:$getVar[no] An error occurred, please try again}{color:$getServerVar[color]}]

$log[[DEBUG] :: $username, used the info command]`,
  },
  {
    type: "awaitedCommand",
    name: "userinfo",
...
$log[[DEBUG] :: $username, used the userinfo command]`,
  },
];
